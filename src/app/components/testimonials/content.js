export const testimonialsData = [
  ...
  //   company: "Brightline",
  //   testimonial:
  //     "We wanted a website that could truly reflect the spirit of our school not just information, but something that captures our students’ energy and achievements. Lazim understood that right away. He designed a platform where we can share moments, highlight student work, and keep parents informed. The site feels personal, vibrant, and easy for our team to manage. It’s made a real difference in how we present ourselves to the community.",
  ...
  //   testimonial:
  //     "We needed a reliable mobile app to help connect service providers with customers, and Lazim helped us get there. He understood what we were trying to build and worked closely with us to make sure the design and flow made sense. The app feels smooth and easy to use, and we're happy with how it turned out. Would definitely consider working with him again in the future.",
  //   image: "/avatars/imran.jpg",
  // },
  // {
  //   name: "Rahul Deshmukh",
  //   initial: "RD",
  //   company: "Prime Wheels Hub",
  //   testimonial:
  //     "Working with Lazim made a big difference for our used car business. Before, managing everything inventory, service records, photos was scattered and time-consuming. Now, it’s much more organized, and updating listings is way easier. The dashboard isn't flashy, but it works really well and does what we need. He also made sure we understood how to use everything without needing help every time. It’s been a solid upgrade for us.",
